...
Double-entry accounts, transactions and entries. Balances are derived from entries; the sum-to-zero and append-only invariants live in SQL, not TypeScript.
